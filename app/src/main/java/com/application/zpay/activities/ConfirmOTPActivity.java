...
public class ConfirmOTPActivity extends zPayActivity {

    String name, mobileNumber, email, password, confirmUserPin, verificationId, imei, model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                //Toast.makeText(ConfirmOTPActivity.this, "Got the code", Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                Toast.makeText(ConfirmOTPActivity.this, "Verification code sent to mobile number.", Toast.LENGTH_LONG).show();
                verificationId = s;
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    showProgressing(ConfirmOTPActivity.this);
                    //Toast.makeText(ConfirmOTPActivity.this, "OTP verified successfully", Toast.LENGTH_SHORT).show();
                    callService(AppUrl.REGISTER, new iNetworkCallback() {
                        @Override
                        public void addParameters(Map<Object, Object> params) {
                            ...
                            params.put(Constants.USER_CONFIRM_PASSWORD, password);
                            params.put(Constants.USER_NAME, name);
                            params.put(Constants.USER_EMAIL, email);
                            params.put(Constants.IMEI_NUMBER, imei);
                            params.put(Constants.MODEL, model);
                        ...
                        public void failure(VolleyError volleyError) {
                            ...
                            Utils.showSnackBar(ConfirmOTPActivity.this, mRootLayout, getString(R.string.something_went_wrong));
                        }
                            ...
                            try {
                                ...
                                if (statusCode == 1) {
                                  /*  String userId=response.getString("userId");
                                    ...
                                    Toast.makeText(ConfirmOTPActivity.this, "Register Successful. Please login", Toast.LENGTH_SHORT).show();
                                    startActivity(new Intent(ConfirmOTPActivity.this, LoginActivity.class));
                                    finish();
                                } else {
                                    String errorMessage = response.getString("errorMessage");
                                    Utils.showSnackBar(ConfirmOTPActivity.this, mRootLayout, errorMessage);
                                }
                    ...
                    if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                        Toast.makeText(ConfirmOTPActivity.this, "Verification Failed, Invalid OTP", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(ConfirmOTPActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        switch (view.getId()) {
            ...
            case R.id.buttonOkay:
                ...
                if (mCode1.length() == 0 || mCode2.length() == 0 || mCode3.length() == 0 || mCode4.length() == 0 || mCode5.length() == 0 || mCode6.length() == 0) {
                    //Utils.showWarningAlert(ConfirmOTPActivity.this,"Enter verification code");
                    Utils.showSnackBar(ConfirmOTPActivity.this, mRootLayout, "Enter verification code");
                } else {
