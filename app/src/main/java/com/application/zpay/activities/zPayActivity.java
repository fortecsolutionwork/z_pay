...
public class zPayActivity extends BaseActivity {
    ...
    protected void callService(String url, final iNetworkCallback networkCallback) {
    ...
    public void addParameters(Map<Object, Object> map) {
    }
}
